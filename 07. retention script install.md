...
# Retention Script installation

##
Navagate retention.sh location
...
```bash
sudo mkdir retention
```

Write new retention.sh file via nano

```bash
sudo nano retention.sh
```
Copy script to nano and save
